...
If you think a simple code example would highlight the issue better, provide a simple example.

Common failure modes to avoid:

- Repeating the finding without saying what should change
- Focusing on implementation taste instead of user or maintainer impact
- Writing comments that are too broad to attach to a specific PR thread
